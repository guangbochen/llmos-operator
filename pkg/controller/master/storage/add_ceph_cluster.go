...
//	_, err := h.namespaces.Get(constant.StorageSystemNamespaceName, metav1.GetOptions{})
//	if err != nil {
//		return fmt.Errorf("failed to get system storage namespace %s: %v", constant.StorageSystemNamespaceName, err)
//	}
//
//	// validate if any ceph cluster already exists
//	_, err = h.clusters.Get(constant.StorageSystemNamespaceName, constant.CephClusterName, metav1.GetOptions{})
//	if err != nil {
...
//			}
//			logrus.Infof("creating new system ceph cluster %s/%s", constant.StorageSystemNamespaceName, constant.CephClusterName)
//			return nil
//		}
...
//			Namespace: constant.StorageSystemNamespaceName,
